...
from src.user.models import User, UserBase
user_manager = UserManager(app, db, User)

# JWT
from flask_jwt import JWT
from src.user.jwt import authenticate, identity

jwt = JWT(app, authenticate, identity)

# controladores book
from src.book.controllers import bookBp
app.register_blueprint(bookBp)

# controladores user
from src.user.controllers import userBp
app.register_blueprint(userBp)

# restful Api
from flask_restful import Api
from src.rest.controllers import BookApi, BookApiId, CategoryBookApiId, TagAddBookApiId, TagRemoveBookApiId, AddressAddBookApiId, AddressRemoveBookApiId
